...
Das Dichtungen-Plugin stellt eine Erweiterung bereit, welche verschiedene Informationen zu [Dichtungen](http://www.dichtungshersteller.info/) im Blog einblenden lässt.
...
1. Entpacke `dichtungen-feed-german.zip`.
2. Lade den `dichtungen-feed-german`-Ordner in dein Verzeichnis `/wp-content/plugins` hoch.
